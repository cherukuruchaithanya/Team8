...
namespace Team8.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString)
        {
            ...
            switch (sortOrder)
            {
                ...
                case "Sid_desc":
                    ...
                    break;
                case "Catpawsid_desc":
                    students = students.OrderByDescending(s => s._919);
                    break;
                default:
        ...
        public async Task<IActionResult> Create([Bind("StudentId,First,Last,Snumber,_919,Done")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,First,Last,Snumber,_919")] Student student)
        {
