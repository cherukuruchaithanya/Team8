...
namespace Team8.Controllers
{
    public class DegreePlanTermRequirementsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString)
        {
            ...
            {
                degreePlanTermRequirement = degreePlanTermRequirement.Where(s => s.Term == Convert.ToInt32(searchString));
            }

            switch (sortOrder)
            {
                case "termID_desc":
                    degreePlanTermRequirement = degreePlanTermRequirement.OrderByDescending(s => s.Term);
                    break;
                case "DegreePlan":
                ...
                case "requirement_desc":
                    ...
                    break;
                default:
                    degreePlanTermRequirement = degreePlanTermRequirement.OrderBy(s => s.Term);
                    break;
            }
        ...
        public async Task<IActionResult> Create([Bind("DegreePlanTermRequirementId,DegreePlanId,Term,RequirementId,Status")] DegreePlanTermRequirement degreePlanTermRequirement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DegreePlanTermRequirementId,DegreePlanId,Term,RequirementId,Status")] DegreePlanTermRequirement degreePlanTermRequirement)
        {
